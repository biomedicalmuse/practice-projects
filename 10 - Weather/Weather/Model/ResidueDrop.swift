...
/// A class that's used to create an individual splash effect when rain or snow falls.
class ResidueDrop: Hashable {
	 var id = UUID()
	 var destructionTime: Double
	 var x: Double
	/*
	 We're not using 1.0 on the Y-axis because it's possible for drops
	  to splatter before they hit the ground.
	 */
	 var y = 0.5
	 var scale: Double
	 var speed: Double
	...
	/*
	 These methods are required for Hashable conformance. 
	 */
