...
class CloudGroup {
	var clouds = [Cloud]()
	let opacity: Double
	/// Stores updates to cloud positions
	...
	/// Figures out how much time has passed since the last uodate
	/// Adjusts each cloud's position by that time, multiplied by the cloud's speed
	/// - Parameter date: whatever day it is
